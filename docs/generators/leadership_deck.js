...
(() => {
  ...
  const stats = [["281", "offline tests incl. 48 CDK assertions", MINT], ["6", "controls native on AgentCore", TEAL], ["3", "regulated controls built & proven", AMBER], ["0", "residual on teardown", NAVY]];
