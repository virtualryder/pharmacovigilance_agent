...
const body = [
  ...
  table(["The accelerator provides", "The sponsor is responsible for"], [
    ...
    ["Reproducible IaC + the 224-test offline suite (41 CDK security assertions)", "Medical review of narratives, causality methodology, and the CSV validation package"],
