...
| **Offline test suite** | **192 / 192** passing (control-plane + **28 CDK stack-synthesis** assertions) |
...
- **192 offline tests** — the CI suite (control-plane + 28 CDK synthesis + 3 CI-completeness gates). Authoritative offline number. Locally you see `191 passed, 1 skipped`: one gate asserts the CDK libs are installed and runs only inside CI.
