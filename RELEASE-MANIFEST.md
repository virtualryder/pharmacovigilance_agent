...
| **Offline test suite** | **206 / 192** passing (control-plane + **30 CDK stack-synthesis** assertions) |
...
- **206 offline tests** — the CI suite (control-plane + 30 CDK synthesis + 3 CI-completeness gates). Authoritative offline number. Locally you see `191 passed, 1 skipped`: one gate asserts the CDK libs are installed and runs only inside CI.
