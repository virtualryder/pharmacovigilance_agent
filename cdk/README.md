...
Supported release tag: `v0.4.0-pilot-rc1` (cut 2026-09-03 after the live governed-core 1.9.0 multi-tenant gate on `pv-mt`; earlier validated tags: `v0.1.1-pilot-rc1` after live EP1, `v0.2.0-pilot-rc1` after EP2; deploy tags, never `main`).
