...
| Test count at the tag | **207** offline tests <!-- count-gate:historical --> at `v0.4.0-pilot-rc1` (31 CDK <!-- count-gate:historical --> assertions) — a record of that tag, not the current tree. Current main (PAR-1 port of the 2026-09-05 controls, 2026-09-06): **264** collected (263 pass + 1 CI-only skip locally; 46 CDK assertions) |
