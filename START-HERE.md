...
token boundary, deterministic Step Functions controller). **What's proven today: the 224-test offline
suite** (control-plane behavior + 41 CDK stack-synthesis security assertions) **plus two live
...
**224 offline tests (incl. 41 CDK synthesis)**, tags `v0.1.1-pilot-rc1` → `v0.4.0-pilot-rc1` (v0.4.0 offline-gated on 1.10.1; v0.3.0 is the last live-gated tag). Evidence:
