...
token boundary, deterministic Step Functions controller). **What's proven today: the 307-test offline
...
**307 offline tests (incl. 48 CDK synthesis)**, tags `v0.1.1-pilot-rc1` → `v0.4.0-pilot-rc1` (v0.4.0 offline-gated on 1.10.1; v0.3.0 is the last live-gated tag). Evidence:
