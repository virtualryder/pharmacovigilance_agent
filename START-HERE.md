...
token boundary, deterministic Step Functions controller). **What's proven today: the 124-test offline
...
**124 offline tests (incl. 23 CDK synthesis)**, tag `v0.1.1-pilot-rc1`. Evidence:
