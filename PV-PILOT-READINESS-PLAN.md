...
full CDK/Gate-B IaC, **live EP1-validated**; **207 offline tests** (control-plane + 31 CDK synthesis + 3 CI-completeness gates + the core-dependency gate).
...
| AWS CDK 7-stack set (`cdk/pv_stacks`) + Gate-B switches | ✅ synth-validated (31 CDK assertions) |
