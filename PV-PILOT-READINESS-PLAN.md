...
full CDK/Gate-B IaC, **live EP1-validated**; **206 offline tests** (control-plane + 30 CDK synthesis + 3 CI-completeness gates + the core-dependency gate).
...
| AWS CDK 7-stack set (`cdk/pv_stacks`) + Gate-B switches | ✅ synth-validated (30 CDK assertions) |
