...
full CDK/Gate-B IaC, **live EP1-validated**; **264 offline tests** (control-plane + 46 CDK synthesis + 3 CI-completeness gates + the core-dependency gate).
...
| AWS CDK 7-stack set (`cdk/pv_stacks`) + Gate-B switches | ✅ synth-validated (46 CDK assertions) |
