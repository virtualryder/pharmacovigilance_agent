...
full CDK/Gate-B IaC, **live EP1-validated**; **112 offline tests** (control-plane + 23 CDK synthesis + 3 CI-completeness gates).
...
**Gate A — code + synth (done).** 112 offline; CDK synthesizes to valid CloudFormation; release
